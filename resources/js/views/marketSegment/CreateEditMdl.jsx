...
function CreateEditMdl({
    ...
    useEffect(() => {
        if (mode === 'Edit Market Segment') {
            setStatusValue(marketSegmentData.status);
                                        ...
                                        <div className="col-12">
                                            <div className="form-group mb-3">
                                                ...
                                                <input
                                                    ...
                                                    id="name"
                                                    name="name"
                                                    placeholder="Market Segment Name"
                                                    value={formData.name || ''}
